...
%Input: A directory path dir_path containing JPEG (.jpg) images.

%Output: A cell array img_struct, where each cell contains the full path to a JPEG image in that folder.
