...
dir_path = '/home/chetan/Documents/Sem6/dip/project_prev_code/jpeg_dc_detection-master/data'
...
for q in range(len(Q_list)):
    ...
    for f in image_range:
        ...
        # print(f)
        original_img = cv2.imread(f"/home/chetan/Documents/Sem6/dip/project_prev_code/jpeg_dc_detection-master/data/ucid.v2/{f}.tif", cv2.IMREAD_GRAYSCALE)   
        # print(ss_img)
        # print(f"{single_path}{f}.jpg")
        print(f"/home/chetan/Documents/Sem6/dip/project_prev_code/jpeg_dc_detection-master/data/ucid.v2/{f}.tif")
        # print(original_img)/
